...
import sys
sys.path.append('.')
from evidence import RetrievalEvidence, AugmentationEvidence
...
class QueryByEntity(RetrievalStrategy):
    ...
    def __init__(self, schema_org_class, clusters=False, rank_evidences_by_table=False, all_attributes=True, tokenizer=None):
