...
def train(dataset_name):
    ...
    val_dataset = ContrastiveClassificationDataset(path=f'./data/processed/{dataset_name}-val-pairs.json.gz',
                                                   dataset=dataset_name)
...
if __name__ == '__main__':
  # Initialize dataset names
    dataset_names = ['amazon-google', 'wdcproducts20pair', 'wdcproducts80pair'] #'walmart-amazon',
