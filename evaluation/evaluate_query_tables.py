...
from indexing.value_normalizer import get_datatype, normalize_value
...
def calculate_aggregated_evidence_scores(all_retrieved_evidences, positive_evidences, k):
    ...
    no_retrieved_verified_evidences = 0
    for evidence in rel_retrieved_evidences:
        for positive_evidence in  positive_evidences:
            if evidence == positive_evidence:
                no_retrieved_verified_evidences += 1
